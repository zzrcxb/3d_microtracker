...
//rongding=0 Nearest microstep; =1 Nearest full step; =2 Nearest half step
...
/*
*makes the current position of the microstage the zero position of the encoder
*the forward and backward LIMITATION info stores in "*status"
*/
...
//return device's basic hardware info, like speed, by "* "
//cannot show moving info and position
...
/*
*Below are functions for MicroDrive1
*/
...
//Prints product name, product id, etc
//cannot show moving info
